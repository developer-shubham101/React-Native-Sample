...
export default class Card extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(
      this,
      'inverted',
      new Animated.Value(getInvertedMultiplier(this.props.gestureDirection)),
    );
    ...
    _defineProperty(this, 'animate', ({closing, velocity}) => {
      const {gesture, transitionSpec, onOpen, onClose, onTransition} =
        this.props;
      const toValue = this.getAnimateToValue({...this.props, closing});
      ...
      onTransition === null || onTransition === void 0
        ? void 0
        : onTransition({
            closing,
    ...
    _defineProperty(
      this,
      'getAnimateToValue',
      ({closing, layout, gestureDirection}) => {
        if (!closing) {
          return 0;
        }
    ...
    _defineProperty(this, 'setPointerEventsEnabled', enabled => {
      ...
      (_this$contentRef$curr = this.contentRef.current) === null ||
      _this$contentRef$curr === void 0
        ? void 0
        : _this$contentRef$curr.setNativeProps({
            pointerEvents,
          });
    });
    ...
    _defineProperty(this, 'handleGestureStateChange', ({nativeEvent}) => {
      const {
        layout,
        onClose,
        onGestureBegin,
      ...
      switch (nativeEvent.state) {
        case GestureState.BEGAN:
          ...
          this.handleStartInteraction();
          onGestureBegin === null || onGestureBegin === void 0
            ? void 0
            : onGestureBegin();
          break;
        ...
        case GestureState.CANCELLED: {
          ...
          onGestureCanceled === null || onGestureCanceled === void 0
            ? void 0
            : onGestureCanceled();
          break;
        }
        ...
        case GestureState.END: {
          ...
          onGestureEnd === null || onGestureEnd === void 0
            ? void 0
            : onGestureEnd();
          break;
        }
    ...
    const distance =
      ...
      gestureDirection === 'vertical-inverted'
        ? (gestureResponseDistance === null ||
          gestureResponseDistance === void 0
            ? void 0
  ...
  render() {
    ...
    const isTransparent = typeof backgroundColor === 'string' ? false : false;
