...
import { initialWindowSafeAreaInsets, SafeAreaConsumer } from "react-native-safe-area-context";
...
const GestureHandlerWrapper =
  GestureHandlerRootView !== null && GestureHandlerRootView !== void 0
...
export default class StackView extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, 'getGesturesEnabled', ({route}) => {
    ...
    _defineProperty(this, 'getPreviousRoute', ({route}) => {
    ...
    _defineProperty(this, 'renderScene', ({route}) => {
      const descriptor =
    ...
    _defineProperty(this, 'handleOpenRoute', ({route}) => {
      const {state, navigation} = this.props;
      const {closingRouteKeys, replacingRouteKeys} = this.state;
    ...
    _defineProperty(this, 'handleCloseRoute', ({route}) => {
      const {state, navigation} = this.props;
    ...
    _defineProperty(this, 'handleTransitionStart', ({route}, closing) => {
      ...
      descriptor === null || descriptor === void 0
        ? void 0
        : (_descriptor$options$o = (_descriptor$options = descriptor.options)
            .onTransitionStart) === null || _descriptor$options$o === void 0
        ? void 0
        : _descriptor$options$o.call(_descriptor$options, {
            closing,
          });
    });

    _defineProperty(this, 'handleTransitionEnd', ({route}, closing) => {
      ...
      descriptor === null || descriptor === void 0
        ? void 0
        : (_descriptor$options$o2 = (_descriptor$options2 = descriptor.options)
            .onTransitionEnd) === null || _descriptor$options$o2 === void 0
        ? void 0
        : _descriptor$options$o2.call(_descriptor$options2, {
            closing,
          });
    });
  ...
  static getDerivedStateFromProps(props, state) {
    ...
    let routes =
      props.state.index < props.state.routes.length - 1 // Remove any extra routes from the state
        ? // The last visible route should be the focused route, i.e. at current index
          props.state.routes.slice(0, props.state.index + 1)
        : props.state.routes; // Now we need to determine which routes were added and removed
    ...
    const getAnimationTypeForReplace = key => {
      ...
      const descriptor = props.descriptors[key] || state.descriptors[key];
      return (_descriptor$options$a =
        descriptor.options.animationTypeForReplace) !== null &&
        _descriptor$options$a !== void 0
        ? _descriptor$options$a
        : 'push';
    };
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          null,
          /*#__PURE__*/ React.createElement(SafeAreaConsumer, null, insets =>
            /*#__PURE__*/ React.createElement(
              KeyboardManager,
              {
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: 'rgba(50,255,0,0.33)',
  },
});
