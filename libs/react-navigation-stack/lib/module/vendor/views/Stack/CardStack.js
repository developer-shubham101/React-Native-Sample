...
const getHeaderHeights = (
  ...
  return routes.reduce((acc, curr) => {
    ...
    const safeAreaInsets = {...insets, ...options.safeAreaInsets};
    const {
...
export default class CardStack extends React.Component {
    ...
    return {
      ...
      scenes: props.routes.map((route, index, self) => {
        ...
        const nextDescriptor =
          props.descriptors[
            nextRoute === null || nextRoute === void 0 ? void 0 : nextRoute.key
          ] ||
          state.descriptors[
            nextRoute === null || nextRoute === void 0 ? void 0 : nextRoute.key
          ];
        const previousDescriptor =
          props.descriptors[
            previousRoute === null || previousRoute === void 0
              ? void 0
              : previousRoute.key
          ] ||
          state.descriptors[
  ...
  constructor(_props) {
    ...
    _defineProperty(this, 'handleHeaderLayout', ({route, height}) => {
      this.setState(({headerHeights}) => {
        ...
        return {
          headerHeights: {...headerHeights, [route.key]: height},
        };
      });
    });
    ...
    _defineProperty(this, 'getPreviousScene', ({route}) => {
    ...
    const {height: _height = 0, width: _width = 0} = Dimensions.get('window');
    this.state = {
      routes: [],
      scenes: [],
      gestures: {},
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        routes.map((route, index, self) => {
          ...
          console.trace('Max:::::::INnnn');
          return /*#__PURE__*/ React.createElement(
            MaybeScreen,
            {
              key: route.key,
              style: [StyleSheet.absoluteFill, {backgroundColor: 'rgba(255,255,255,0.43)'}],
              enabled: detachInactiveScreens,
